...
public class RTTC_072_POM_ErrorMsgForInvalidProductAdd {
private WebDriver driver; 
	
	public RTTC_072_POM_ErrorMsgForInvalidProductAdd(WebDriver driver) {
		this.driver = driver; 
	...
	//	@FindBy (xpath="//*[@id=\"discount\"]/tfoot/tr/td[2]/button")
		...
		//For search of a product all below are locator
		...
		private WebElement quantitySearch;
...
//methods for LOGIN clicks
	...
	public void searchProductName(String productNameSearch) {
		this.productNameSearch.clear(); 
		this.productNameSearch.sendKeys(productNameSearch); 
		//productNameSearch
	}
	public void searchPriceTextbox(String priceSearch) {
		this.priceSearch.clear(); 
		this.priceSearch.sendKeys(priceSearch); 
	}
	
	public void searchModelTextbox(String modelSearch) {
		this.modelSearch.clear(); 
		this.modelSearch.sendKeys(modelSearch); 
	}
	
	public void searchQuantityTextbox(String quantitySearch) {
		this.quantitySearch.clear(); 
		this.quantitySearch.sendKeys(quantitySearch); 
	}
	public void Errormessage() {
		this.warningmessage.click();
	}
}
