...
/*RTTC_073: To Verify whether added product details get stored in database.
Note: Babita - 25/09/2019 - Product is added by Admin to the application and Live DB validation is currently not in our scope, so as a workaround
have created a table product and inserted one record as per this TC data in the table.
and though this TC, Maria DB connection was established and fetched record from our own Maria DB table to this code and print it to the console. */

public class RTTC_073_Test_VerifyAddedProductStoredInDatabase {
	...
	public void AddProductTest() throws InterruptedException {
		...
		//This step saved the added product and validate success message
		...
		System.out.println("*Application allowed admin to add product with the rewards point, Hence this TC execution is passed!");
		//Capture Screen shot
		...
		@Test ( priority = 5)
		//This step do a search of the added product in Application URL
		...
		@Test ( priority = 6)
		// This step display the search result of the added product in table format from product list in Application URL
		...
		@Test(priority = 7, dataProvider = "db-inputs", dataProviderClass = VerifyAddedProductDataProvider_RTTC_073.class)
		public void loginDBTest(String pname, String mTitle, String model, String tprice, String category, String qty, String uprice, String pts) {
			//This @test step display the data into the Console from Maria DB product table
